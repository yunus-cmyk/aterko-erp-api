...
function teslimatVeri(t, kullaniciAd) {
    ...
    if (t.montaj_gerekli === false) veri['Montaj'] = 'Yok';   // Projede montaj gerekli değilse Montaj bölümü gizlenir
    return veri;
}
...
module.exports = { teknikSartnameHTML, teslimatVeri, cevapBicim, motorIsle, bolumGizliMi };
